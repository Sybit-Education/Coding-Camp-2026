  ...
  <div class="page-view">
    ...
    <section class="my-5">
      ...
      <div class="flex-sm flex-col md:flex-row">
        ...
        <p>
          ...
          besonderen Dank gilt all umserem Teilnehmern, die mit Leidenschaft, Teamgeist und Ausdauer
          an diesem Projekt gearbeitet haben. Jede Komponente, jede Zeile Code und jede Entscheidung
          dahinter spiegelt den Lernprozess und das Engagement aller Beteiligten wieder.
        </p>

        <h2 class="flex-md"><UsersIcon /> Das Team</h2>
        <!-- Right -->
    ...
    <div class="card-sybit my-5">
      ...
      <p>
        ...
        jährlich in der ersten vollen Woche der Sommerferien im Rahmen des Ferienprogramms der Stadt
        Radolfzell statt. Viele ehemalige Teilnehmende sind heute fester Bestandteil des
        Unternehmens und besuchen das Coding Camp regelmäßig, um sich inspirieren zu lassen und den
        aktuellen Projekten zu folgen.
      </p>

      <a class="flex items-center text-[#c9ff29]" href="https://www.sybit.education/">
        Website Nachwuchskräfte SYBIT
    ...
    <div class="card-sybit my-5">
      ...
      <p>
        ...
        Als strategischer Partner begleitet SYBIT Unternehmen dabei, kundenzentrierte Prozesse zu
        gestalten und innovative Lösungen entlang der gesamten Customer Journey zu implementieren.
        Mit über 25 Jahren Erfahrung und als Teil der NTT Data Business Solutions treibt SYBIT die
        digitale Transformation nachhaltig voran. We create Customer Experience Champions!
      </p>
      <a class="flex items-center text-[#c9ff29]" href="https://www.sybit.education/">
        SYBIT GmbH
        <ExternalLinkIcon class="size-5" />
